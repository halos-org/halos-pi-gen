...
- If `wf-panel-pi.ini` already exists (user has customized panel), appends Cockpit to the end of existing launchers
- If `wf-panel-pi.ini` doesn't exist, installs default configuration with standard launchers plus Cockpit
